...
public class TakeViewF extends View {

	private Context mContext;

	public TakeViewF(Context context) {
		super(context);
		mContext=context;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		p.setStrokeWidth(3);
		Path path=new Path();
		path.moveTo(DisplayUtil.dip2px(mContext,50)+buttomWidth/2, DisplayUtil.dip2px(mContext,325));
		...
		path.lineTo(DisplayUtil.dip2px(mContext,100)+buttomWidth, DisplayUtil.dip2px(mContext,175));
