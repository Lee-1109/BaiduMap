...
public class DrawViewA extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		path.lineTo(DisplayUtil.dip2px(mContext,50)+buttomWidth/2, DisplayUtil.dip2px(mContext,50)/2);
		path.lineTo(DisplayUtil.dip2px(mContext,50)+buttomWidth/2, DisplayUtil.dip2px(mContext,50));
