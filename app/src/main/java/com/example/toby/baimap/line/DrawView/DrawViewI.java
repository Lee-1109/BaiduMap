...
public class DrawViewI extends View {

	private Context mContext;

	public DrawViewI(Context context) {
		super(context);
		mContext=context;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		path.lineTo(screenWidth/2+ DisplayUtil.dip2px(mContext,50)+buttomWidth, DisplayUtil.dip2px(mContext,50)/2);
		path.lineTo(screenWidth/2+ DisplayUtil.dip2px(mContext,50)+buttomWidth, DisplayUtil.dip2px(mContext,50));
