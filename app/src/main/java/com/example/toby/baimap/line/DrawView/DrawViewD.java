...
public class DrawViewD extends View {

	private Context mContext;

	public DrawViewD(Context context) {
		super(context);
		mContext=context;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		path.lineTo(DisplayUtil.dip2px(mContext,50)+buttomWidth, DisplayUtil.dip2px(mContext,375));
