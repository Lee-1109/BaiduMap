...
public class DrawViewJ extends View {

	private Context mContext;

	public DrawViewJ(Context context) {
		super(context);
		mContext=context;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		path.lineTo(screenWidth/2+ DisplayUtil.dip2px(mContext,50)/2+buttomWidth/2, DisplayUtil.dip2px(mContext,175));
		path.lineTo(screenWidth/2+ DisplayUtil.dip2px(mContext,50)/2+buttomWidth/2+ DisplayUtil.dip2px(mContext,25), DisplayUtil.dip2px(mContext,175));
